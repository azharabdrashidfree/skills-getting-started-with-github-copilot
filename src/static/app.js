document.addEventListener("DOMContentLoaded", () => {
              ...
              .map(
                (participant) => `
                  <div class="participant-row">
                    ...
                    <button class="participant-delete" data-activity="${name}" data-email="${participant}" type="button" title="Remove ${participant}">
                      ×
                    </button>
                  </div>
                `
  ...
  async function handleParticipantRemoval(activityName, email) {
    try {
  ...
  activitiesList.addEventListener("click", (event) => {
    ...
    if (deleteButton) {
      ...
      handleParticipantRemoval(activityName, email);
    }
  });
